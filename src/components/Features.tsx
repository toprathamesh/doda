...
const features = [
  {
    ...
    title: "Convertible Spaces",
    description: "Instantly transform your living area into a workspace, healthcare suite, or culinary kitchen with our modular design."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    title: "Dynamic Amenities",
    description: "Access amenities when you need them with our subscription model. Gym, pool, coworking spaces and more available on demand."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Every Obvian space comes equipped with cutting-edge smart technology that learns your preferences and adapts to you."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Join a vibrant community of like-minded individuals with regular events, workshops and networking opportunities."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Our modular approach reduces waste and optimizes energy usage, making Obvian a leader in sustainable urban living."
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Advanced security systems protect your space while our privacy-first approach ensures your data remains yours alone."
  },
];
