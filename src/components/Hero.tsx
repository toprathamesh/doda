        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className={`text-center lg:text-left transition-all duration-1000 ${
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <Button 
                className="bg-obvian-cyan text-obvian-black hover:bg-obvian-cyan/80 px-8 py-6 text-lg button-hover group"
          ...
          <div className={`relative h-[400px] md:h-[500px] transition-all duration-1000 delay-300 ${
            ...
            <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(33,230,193,0.2)]">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
                <button className="w-16 h-16 bg-obvian-cyan/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-obvian-cyan/30 transition-all hover:scale-110 group">
